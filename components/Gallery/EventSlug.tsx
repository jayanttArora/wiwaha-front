...
const EventSection = ({
  ...
  const events = Array.from({ length: totalEvents }, (_, i) => ({
    ...
    name:
      title === "All Events"
        ? `Event Name ${String(i + 1).padStart(2, "0")}`
      ...
      <div className="flex flex-row justify-between items-center 1440:mb-8 1080:mb-6 650:mb-5 480:mb-5 mb-4">
        ...
        <div className="flex flex-row gap-4">
          ...
          <button
            ...
            className={`rounded-full bg-[#F3EEEA] border border-[#EDE3D9] flex items-center justify-center transition-colors cursor-pointer group ${
              !showLeftArrow
...
const EventSlug = () => {
  const eventSections = [
    {
      title: "All Events",
      imagePath: "/images/about/ourStory/imgC1R1.png",
    },
    {
      title: "Wedding Events",
      imagePath: "/images/contact/contactUs/img1.jpg",
    },
    {
      title: "Corporate Events",
      imagePath: "/images/events/weddingEvents/corporate.jpg",
    },
    {
      title: "Private Celebrations",
      imagePath: "/images/events/weddingEvents/private.jpg",
    },
    {
      title: "Social Gatherings",
      imagePath: "/images/events/weddingEvents/social.jpg",
    },
  ];
    ...
    <section className="flex flex-col 1440:py-8 1080:py-6 650:py-4 480:py-4 py-4">
      <div className="container mx-auto px-4 w-full 480:max-w-[700px] 650:max-w-[900px] 1080:max-w-[1200px] 1440:max-w-[1400px]">
        {eventSections.map((section, index) => (
          <div key={section.title} className={index > 0 ? "mt-12" : ""}>
            <EventSection title={section.title} imagePath={section.imagePath} />
          </div>
        ))}
      </div>
    </section>
