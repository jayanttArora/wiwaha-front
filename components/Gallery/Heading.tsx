...
const Heading = () => {
  return (
    <section className="bg-[#F3EEEA] pt-[calc(var(--navbar-height)+32px)] 1440:pb-12 1080:pb-12 650:pb-10 480:pb-8 pb-6">
      <div className="container mx-auto px-4 w-full 480:max-w-[700px] 650:max-w-[900px] 1080:max-w-[1200px] 1440:max-w-[1400px]">
        ...
        {/* Description Text */}
        <p className="font-roboto font-normal 1440:text-[20px] 1080:text-[16px] 650:text-[14px] 480:text-[12px] text-[12px] tracking-[1.4px] text-[#9D7336] text-center max-w-[800px] mx-auto">
